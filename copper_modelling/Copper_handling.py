...
menu_choice = st.sidebar.radio("Menu", ["Predict", "Contact"])
...
if menu_choice == "Predict":
    ...
    with st.form("my_form"):
        ...
        with col3:
            st.write(
                f'<h5 style="color:rgb(255, 165, 0);">NOTE: Min & Max given for reference, you can enter any value</h5>',
                unsafe_allow_html=True)
    ...
    st.write("Regards,")
    st.write(
        "I am excited to share the successful completion of the 'Industrial Copper Modeling Application' project. By leveraging Python, Streamlit, and machine learning libraries, I've developed a predictive solution for industrial copper modeling.")
    st.write(
        "The application allows users to predict selling prices and status based on input parameters. It incorporates machine learning models trained on historical data, providing valuable insights for decision-making in the industrial context.")
    st.write(
        "With a user-friendly interface, the application aims to assist professionals in making informed decisions related to industrial copper pricing and status prediction.")
    st.write(
        "Thanks to the support and guidance from GUVI Geek Networks, the IIT Madras Data Science Programme at IITMRP, and the collaborative efforts of IITMDSA Zen DataScience and GUVI. Excited about more ventures ahead!"
    )
